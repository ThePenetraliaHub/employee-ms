...
<div class="form-row">
    <div class="col-md-6">
        <div class="form-group col-xs-11{{ $errors->has('leave_name') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="leave_name" type="text" class="form-control" name="leave_name" value="{{ old('leave_name', $leave_type->leave_name) }}" required>
        ...
        <div class="form-group col-xs-11{{ $errors->has('description') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <textarea rows="4" id="description" type="textarea" class="form-control" name="description" required placeholder="Description of leave here...">{{ old('description', $leave_type->description) }}</textarea>
    ...
    <div class="col-md-6">
        <div class="form-group col-xs-11{{ $errors->has('number_of_days') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="number_of_days" type="number" class="form-control" name="number_of_days" value="{{ old('number_of_days', $leave_type->number_of_days) }}" required>
       ...
       <div class="form-group col-xs-11{{ $errors->has('eligibility') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <select class="form-control" name="eligibility" id="eligibility">
                <option value="All" @if (old('eligibility', $leave_type->eligibility) == 'All') {{ 'selected' }} @endif>All</option>
                <option value="Male" @if (old('eligibility', $leave_type->eligibility) == 'Male') {{ 'selected' }} @endif>Male</option>
                <option value="Female" @if (old('eligibility', $leave_type->eligibility) == 'Female') {{ 'selected' }} @endif>Female</option>
            </select>
       ...
       <div class="form-group col-xs-11{{ $errors->has('compulsory') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <select class="form-control" name="compulsory" id="compulsory">
                <option value="No" @if (old('compulsory', $leave_type->compulsory) == 'No') {{ 'selected' }} @endif>No</option>
                <option value="Yes" @if (old('compulsory', $leave_type->compulsory) == 'Yes') {{ 'selected' }} @endif>Yes</option>
            </select>
    ...
    <div class="col-md-6">
        <div class="form-group col-xs-11{{ $errors->has('is_active') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <select class="form-control" name="is_active" id="is_active">
                <option value="Active" @if (old('is_active', $leave_type->is_active) == 'Active') {{ 'selected' }} @endif>Active</option>
                <option value="Inactive" @if (old('is_active', $leave_type->is_active) == 'Inactive') {{ 'selected' }} @endif>Inactive</option>
            </select>
