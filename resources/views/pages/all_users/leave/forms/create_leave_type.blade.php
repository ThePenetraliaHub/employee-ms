<div class="form-row">
   ...
   <div class="col-md-6">
        <div class="form-group col-xs-11{{ $errors->has('days') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="days" type="number" class="form-control" name="days" value="{{ old('days') }}" required>
            @if ($errors->has('days'))
                <span class="help-block">
        ...
        <div class="form-group col-xs-11{{ $errors->has('effective_from') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="effective_from" type="date" class="form-control" name="effective_from" value="{{ old('effective_from') }}" required>
       ...
       <div class="form-group col-xs-11{{ $errors->has('gender') ? ' has-error' : '' }} mb-0 mt-3">
           ...
           <select class="form-control" name="gender" id="gender" sellected="{{ old('leave_name') }}">
               <option value="All" @if (old('gender') == 'All') {{ 'selected' }} @endif>All</option>
