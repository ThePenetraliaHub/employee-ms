            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="{{ $active=='inbox' ? 'active' : '' }}">
                    <a href="{{route('message.inbox')}}">
                        ...
                        <span class="label label-primary pull-right">{{ auth()->user()->unread_inbox_message()->count() }}</span>
                    </a>
                </li>
                ...
                <li class="{{ $active=='trash' ? 'active' : '' }}">
                    <a href="{{route('message.trash.index')}}">
                        ...
                        <span class="label label-primary pull-right">{{ auth()->user()->unread_trash_message()->count() }}</span>
                    </a>
                </li>
