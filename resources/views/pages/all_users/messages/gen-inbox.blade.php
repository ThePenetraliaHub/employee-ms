...
@section('content')
 <div class="right_col" role="main">
      <div class="row">
      @include('pages.all_users.messages.gen-sidebar', ['active'=>'inbox'])
            <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> <small>inbox</small></h2>
                                                ...
                                                @foreach($messages as $message)
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-subject text-truncate" style="max-width: 250px;">
                                                            ...
                                                            <span class="text-muted"> {!! substr($message->content,0,100). '....'!!} </span>
                                                        </td>
                                                        ...
                                                        <td class="text-center">
                                                                ...
                                                                <button class="delete-btn btn btn-danger btn-sm glyphicon glyphicon-trash" data-toggle="modal" data-target="#deleteModal" href="#" role="button" data-messageId="{{ $message->id }}"></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
