<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST" action="{{ route('employee-status.update', $employee_status->id) }}">
{{csrf_field()}}  
{{method_field('PUT')}} 
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="title"  name="title"   value="{{ old('title',$employee_status->title) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('title'))
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        ...
        {{ old('description',$employee_status->description) }}
        </textarea>
