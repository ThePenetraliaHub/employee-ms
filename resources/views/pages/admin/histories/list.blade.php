                                  ...
                                  <tbody>
                                      @foreach($histories as $history)
                                        <tr>
                                            ...
                                            <td>   
                                                <span class="">{{\App\Employee::find($history->sender->id)->name  }} </span><br>
                                                <span class="text-muted"><small>{{\App\Department::find($history->sender->department_id)->name}}</small></span> 
                                            </td>
                                            <td>{{ $history->collector->name }}</td>
                                             <td>
                                                <span class="">{{ $history->reciever->name }} </span><br>
                                                <span class="text-muted"><small>{{\App\Department::find($history->reciever->id)->name }}</small></span>
                                            </td>
