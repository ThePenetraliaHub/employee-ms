<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST"action="{{ route('projects.store') }}">
    @csrf
    ...
    <div class="item form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="form-group has-feedback">
                        <input type="text" name="start_date" class="form-control col-md-7 col-xs-12 has-feedback-left " id="start_date"  aria-describedby="inputSuccess2Status4">
    ...
    <div class="item form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="form-group has-feedback">
                        <input type="text" name="end_date" class="form-control col-md-7 col-xs-12 has-feedback-left " id="end_date"  aria-describedby="inputSuccess2Status4">
                        <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                        <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                    </div>
