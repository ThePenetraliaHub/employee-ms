<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST"action="{{ route('pay-grade.update', $pay_grade->id) }}">
{{csrf_field()}}  
{{method_field('PUT')}} 
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="title"  name="title"  value="{{ old('title',$pay_grade->title) }}"" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('title'))
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="number" id="min_salary"  name="min_salary" value="{{ old('min_salary',$pay_grade->min_salary) }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="number" id="max_salary"  name="max_salary" value="{{ old('max_salary',$pay_grade->max_salary) }}" required="required" class="form-control col-md-7 col-xs-12">
