<div class="form-row">
    ...
    <div class="form-group col-xs-11{{ $errors->has('min_salary') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="min_salary" type="number" class="form-control" name="min_salary" value="{{ old('min_salary') }}" required>
    ...
    <div class="form-group col-xs-11{{ $errors->has('max_salary') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="max_salary" type="number" class="form-control" name="max_salary" value="{{ old('max_salary') }}" required>
