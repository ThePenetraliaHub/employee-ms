                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                         ...
                                         @if(auth()->user()->can('edit_employee_user'))
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" title="Deactivate Employee Account" class="activate btn-sm btn btn-warning fa fa-lock text-danger pointer" role="button" data-userId="{{ $user->id }}">
                                            </a>
                                            @endif
                                        
                                            @if($user->is_active == 0 && $user->id != auth()->user()->id && auth()->user()->can('activate_deactivate_employee_user'))
                                            <a data-toggle="tooltip" data-placement="top" title="Activate Employee Account" class="activate btn-sm btn btn-success fa fa-unlock text-success pointer" role="button" data-userId="{{ $user->id }}">
                                            </a>
                                            @endif
                                        </div>
