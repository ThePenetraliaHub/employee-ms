<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST"action="{{ route('client.store') }}">
    @csrf
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="email" id="contact_email"  name="contact_email" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="url" id="company_url"  name="company_url" class="form-control col-md-7 col-xs-12">
    ...
    <div class="item form-group {{ $errors->has('first_contact_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="form-group has-feedback">
                        <input type="text" name="first_contact_date" class="form-control col-md-7 col-xs-12 has-feedback-left " id="single_cal4"  aria-describedby="inputSuccess2Status4">
