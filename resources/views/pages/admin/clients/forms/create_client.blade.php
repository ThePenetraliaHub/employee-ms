<div class="form-row">
    ...
    <div class="form-group col-xs-11{{ $errors->has('contact_number') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="contact_number" type="text" class="form-control" name="contact_number" value="{{ old('contact_number') }}" required data-parsley-type="number" minlength="11" maxlength="11">
    ...
    <div class="form-group col-xs-11{{ $errors->has('status') ? ' has-error' : '' }} mb-0 mt-3">
     ...
     <div class="form-group col-xs-11{{ $errors->has('first_contact_date') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="first_contact_date" type="date" class="form-control" name="first_contact_date" value="{{ old('first_contact_date') }}" required>
