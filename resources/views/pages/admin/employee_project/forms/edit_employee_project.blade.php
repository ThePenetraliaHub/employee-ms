<div class="form-row">
    ...
    <div class="form-group col-xs-11{{ $errors->has('start_date') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="start_date" type="date" class="form-control" name="start_date" value="{{ old('start_date',$employee_project->start_date) }}" required placeholder="Project/Task start date here..">
    ...
    <div class="form-group col-xs-11{{ $errors->has('end_date') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="end_date" type="date" class="form-control" name="end_date" value="{{ old('end_date',$employee_project->end_date) }}" required placeholder="Project/Task end date here..">
