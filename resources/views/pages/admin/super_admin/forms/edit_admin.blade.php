<div class="form-row">
    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-xs-11 mb-0 mt-3">
      ...
      <input name="name" value="{{ old('name', $admin->user_info->name) }}" class="form-control" placeholder="" required/>
      @if ($errors->has('name'))
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} col-xs-11 mb-0 mt-3">
      ...
      <input type="email" name="email" value="{{ old('email', $admin->user_info->email) }}" class="form-control" placeholder="" required/>
      @if ($errors->has('email'))
          <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }} col-xs-11 mb-0 mt-3">
      ...
      <input name="phone" value="{{ old('phone', $admin->phone) }}" class="form-control" placeholder="" required/>
      @if ($errors->has('phone'))
          <span class="invalid-feedback" role="alert">
