<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.update', $user->owner->id)}}" >
    @csrf
    {{method_field('PUT')}} 
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="name"  name="name"  value="{{ old('name', $user->name) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('name'))
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="email" id="email"  name="email"  value="{{ old('email', $user->email) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('email'))
            <span class="help-block">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="phone"  name="phone"  value="{{ old('phone', $user->owner->phone) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('phone'))
            <span class="help-block">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="address"  name="address"  value="{{ old('address', $user->owner->address) }}" required="required" class="form-control col-md-7 col-xs-12">
