<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST"action="{{ route('skills.store') }}">
    @csrf
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="skill_title"  name="skill_title" value="{{ old('skill_title') }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <textarea id="detail"  name="detail" required="required" class="form-control col-md-7 col-xs-12">{{ old('detail') }}
        </textarea>
