<div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-xs-11{{ $errors->has('certification') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="certification" type="text" class="form-control" name="certification" value="{{ old('certification') }}" required>
    ...
    <div class="form-row">
        <div class="form-group col-xs-11{{ $errors->has('valid_on') ? ' has-error' : '' }} mb-0 mt-3">
            ...
            <input id="valid_on" type="date" class="form-control" name="valid_on" value="{{ old('valid_on') }}" required>
