...
<form id="submit_form" novalidate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="{{ route('certification.update', $certification->id) }}">
{{csrf_field()}}  
{{method_field('PUT')}} 
    ...
    <div class="item form-group {{ $errors->has('employee_id') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
            <select class="form-control col-md-7 col-xs-12" id="employee_id" name="employee_id"required="required" style="width: 100%;"  disabled>
    ...
    <div class="item form-group {{ $errors->has('certification') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
            <input type="text" id="certification"  name="certification" value="{{ old('certification',$certification->certification) }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="item form-group {{ $errors->has('institution') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
            <input type="text" id="institution"  name="institution"  value="{{ old('institution',$certification->institution) }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="item form-group {{ $errors->has('granted_on') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
            <div class="form-group has-feedback">
                <input type="text" name="granted_on"  value="{{ old('granted_on',$certification->granted_on->format('Y-m-d')) }}" class="form-control col-md-7 col-xs-12 has-feedback-left " id="granted_on"  aria-describedby="inputSuccess2Status4">
    ...
    <div class="item form-group {{ $errors->has('valid_on') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
            <div class="form-group has-feedback">
                <input type="text" name="valid_on" value="{{ old('valid_on',$certification->valid_on->format('Y-m-d')) }}" class="form-control col-md-7 col-xs-12 has-feedback-left " id="valid_on"  aria-describedby="inputSuccess2Status4">
                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                <span id="inputSuccess2Status4" class="sr-only">(success)</span>
            </div>
