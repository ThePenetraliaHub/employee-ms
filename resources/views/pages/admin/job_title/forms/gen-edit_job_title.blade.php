<form id="submit_form" novalidate class="form-horizontal form-label-left" method="POST" action="{{ route('job-title.update', $job_title->id) }}">
{{csrf_field()}}  
{{method_field('PUT')}}  
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="code"  name="code" value="{{ old('code',$job_title->code) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('code'))
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="title"  name="title" value="{{ old('title',$job_title->title) }}" required="required" class="form-control col-md-7 col-xs-12">
        @if ($errors->has('title'))
            <span class="help-block">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <textarea id="description"  name="description" required="required" class="form-control ">
         {{ old('description',$job_title->description) }}</textarea>
