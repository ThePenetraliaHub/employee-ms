    ...
    <div class="form-group col-xs-11{{ $errors->has('code') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="code" type="text" class="form-control" name="code" value="{{ old('code',$job_title->code) }}" required>
        @if ($errors->has('code'))
    ...
    <div class="form-group col-xs-11{{ $errors->has('title') ? ' has-error' : '' }} mb-0 mt-3">
        ...
        <input id="title" type="text" class="form-control" name="title" value="{{ old('title',$job_title->title) }}" required>
        @if ($errors->has('title'))
            <span class="help-block">
