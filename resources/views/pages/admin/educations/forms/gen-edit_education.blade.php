<form id="submit_form" novalidate class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST"action="{{route('education.update', $education->id) }}">
{{csrf_field()}}  
{{method_field('PUT')}} 
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <select class="form-control col-md-7 col-xs-12" id="employee_id" disabled name="employee_id"required="required" style="width: 100%;">
             <option value=""></option>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="qualification"  name="qualification"  value="{{ old('qualification', $education->qualification) }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12 ">
        <input type="text" id="institution"  name="institution" value="{{ old('institution', $education->institution) }}" required="required" class="form-control col-md-7 col-xs-12">
    ...
    <div class="item form-group {{ $errors->has('start_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="form-group has-feedback">
                        <input type="text" name="start_date" value="{{ old('start_date', $education->start_date->format("Y-m-d")) }}"  class="form-control col-md-7 col-xs-12 has-feedback-left " id="start_date"  aria-describedby="inputSuccess2Status4">
    ...
    <div class="item form-group {{ $errors->has('end_date') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 ">
                    <div class="form-group has-feedback">
                        <input type="text" name="end_date"  value="{{ old('end_date', $education->end_date->format("Y-m-d")) }}" class="form-control col-md-7 col-xs-12 has-feedback-left " id="end_date"  aria-describedby="inputSuccess2Status4">
                        <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                        <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                    </div>
